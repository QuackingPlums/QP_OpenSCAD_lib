...
// ** AWAITING VERIFICATION **
	18, 4, 12.4, 12.4,	// stator d, stator h, bottom mount hole centers min, max
...
QPAV250_generic = ["generic 250 quad motor",
	0, 0, 12, 14,	// stator d, stator h, bottom mount hole centers min, max
...
function motor_base_mount_hole_size(motor_type) = motor_type[22];
