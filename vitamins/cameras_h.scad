...
GoPro_HD_Hero3_Black = ["GoPro HD Hero3: Black Edition",		// GoPro HD Hero3	 ** VERIFIED **
	...
	23.0, 15.05, 8, 7.0];		// lens diameter, lens x-offset, lens y-offset, lens z-offset (from center)
// mass = 75g
...
GoPro_HD_Hero2 = ["GoPro HD Hero2",							// GoPro HD Hero2 ** VERIFIED **
	...
	"None",					// mount type ** DEPRECATED **
	20.5, 14.6, 8, 3.6];		// lens diameter, lens x-offset, lens y-offset, lens z-offset (from center)
...
lens y-offset from front of body (how far it sticks out)
